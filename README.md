...
|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-----------|
| `community`   | 399 for Python, 364 for Terraform, 360 for JavaScript, 247 for TypeScript, 228 for Regex, 148 for Generic, 141 for Java, 104 for YAML, 101 for Ruby, 90 for Go, 59 for PHP, 49 for Solidity, 48 for C#, 39 for Dockerfile, 34 for OCaml, 32 for JSON, 25 for Scala, 17 for Kotlin, 17 for C, 12 for Apex, 11 for Rust, 9 for Bash, 7 for Elixir, 5 for Swift, 5 for Clojure, 3 for HTML, 1 for Lua | Semgrep        | LGPL 2.1  |
...
| `elttam`      | 40 for Java, 15 for Generic, 7 for YAML, 3 for JavaScript, 3 for Go, 2 for TypeScript, 1 for Kotlin, 1 for Python, 1 for C, 1 for C#, 1 for PHP                                                                                                                                                                                                                                                    | elttam         | MIT       |
